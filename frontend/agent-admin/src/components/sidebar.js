            ...
            <div className={this.state._show ? `sidebar` : 'sidebar sidebar-hidden'}>
                <div className="items">
                    ...
                    <ul>
                        ...
                        <li>
                            <Link to='/carBundles' className={this.props[0].location.pathname === '/carBundles' ? 'active' : null}>
                                <Isvg src={list} />
                                Car Bundles
                            </Link>
                        </li>
                        <li>
                            <Link to='/pricelist/new' className={this.props[0].location.pathname === '/pricelist/new' ? 'active' : null}>
                                <Isvg src={list} />
                                Create Pricelist
                            </Link>
                        </li>

...
const { utilConcatBuf } = require('pvutils')
...
webcrypto.subtle.getRandomValues = getRandomValues;
webcrypto.subtle.getAlgorithmByOID = getAlgorithmByOID;
webcrypto.subtle.getOIDByAlgorithm = getOIDByAlgorithm;
webcrypto.subtle.getAlgorithmParameters = getAlgorithmParameters;
webcrypto.subtle.encryptEncryptedContentInfo = encryptEncryptedContentInfo;
webcrypto.subtle.decryptEncryptedContentInfo = decryptEncryptedContentInfo;
webcrypto.subtle.stampDataWithPassword = stampDataWithPassword;
webcrypto.subtle.verifyDataStampedWithPassword = verifyDataStampedWithPassword;
